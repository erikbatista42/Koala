...
class LoginController: UIViewController, UIScrollViewDelegate, FBSDKLoginButtonDelegate {
...
//        let loginController = storyboard?.instantiateViewController(withIdentifier: "Startpage") as! ViewController
//        
